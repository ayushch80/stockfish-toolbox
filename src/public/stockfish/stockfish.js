...
var Stockfish = (function() {
    ...
    return (
        function(Stockfish) {
            ...
            E = "object" === typeof process && "object" === typeof process.versions && "string" === typeof process.versions.node;
            ...
            } else if (na || D) D ? G = self.location.href : "undefined" !== typeof document && document.currentScript && (G = document.currentScript.src), _scriptDir && (G = _scriptDir), 0 !== G.indexOf("blob:") ? G = G.substr(0, G.lastIndexOf("/") + 1) : G = "", E ? (H = function(a, b) {
                J || (J = require("fs"));
                K || (K = require("path"));
                a = K.normalize(a);
                return J.readFileSync(a,
                    b ? null : "utf8")
            }, I = function(a) {
                a = H(a, !0);
                a.buffer || (a = new Uint8Array(a));
            ...
            function Ma() {
                return P || !na && !D || "function" !== typeof fetch ? Promise.resolve().then(function() {
                    return La()
                }) : fetch(U, {
            ...
            function Pa(a) {
                for (; 0 < a.length;) {
                    ...
                    if ("function" == typeof b) b(z);
                        ...
                        var c = b.Ia;
                        "number" === typeof c ? void 0 === b.ma ? Ca.get(c)() : Ca.get(c)(b.ma) : c(void 0 === b.ma ? null : b.ma)
                    }
                }
            }
            ...
            function Qa(a, b) {
                ...
                var c = Atomics.load(v(), V >> 2),
                    e = 0;
                if (c == a && Atomics.compareExchange(v(), V >> 2, c, 0) == c && (--b, e = 1, 0 >= b)) return 1;
            ...
            function Ra(a) {
                if (F) throw "Internal Error! cleanupThread() can only ever be called from main application thread!";
            ...
            var A = {
                ...
                Ua: function(a) {
                    var b = X();
                    b && (Atomics.store(y(),
                        b + 4 >> 2, a), Atomics.store(y(), b + 0 >> 2, 1), Atomics.store(y(), b + 56 >> 2, 1), Atomics.store(y(), b + 60 >> 2, 0), A.Da(), Qa(b + 0, 2147483647), Sa(0, 0, 0), F && postMessage({
                        cmd: "exit"
                    }))
                },
                Ta: function() {
                ...
                Ea: function() {
                    ...
                    A.fa = [];
                    for (a = 0; a < A.ia.length; ++a) c = A.ia[a], b = c.ea,
                        A.ya(b), c.terminate();
                    A.ia = []
                },
                ya: function(a) {
                ...
                Ba: function(a, b) {
                    a.onmessage = function(c) {
                        ...
                        if (e.targetThread && e.targetThread != X()) {
                            var g =
                                A.ga[e.lb];
                            g ? g.worker.postMessage(c.data, e.transferList) : console.error('Internal error! Worker sent a message "' + h + '" to target pthread ' + e.targetThread + ", but that thread no longer exists!")
                            ...
                            c = e.thread;
                            if (F) throw "Internal Error! killThread() can only ever be called from main application thread!";
                            ...
                            c = e.thread;
                            if (F) throw "Internal Error! cancelThread() can only ever be called from main application thread!";
                            if (!c) throw "Internal Error! Null pthread_ptr in cancelThread!";
                            A.ga[c].worker.postMessage({
                                cmd: "cancel"
                            })
                        } else if ("loaded" === h) a.loaded = !0, b && b(a), a.na && (a.na(), delete a.na);
                        else if ("print" === h) qa("Thread " + e.threadId + ": " + e.text);
                        else if ("printErr" === h) N("Thread " +
                            e.threadId + ": " + e.text);
                        else if ("alert" === h) alert("Thread " + e.threadId + ": " + e.text);
                        else if ("exit" === h) a.ea && Atomics.load(y(), a.ea.ha + 64 >> 2) && A.ta(a);
                        else if ("exitProcess" === h) try {
                            Za(e.returnCode)
                        } catch (m) {
                            if (m instanceof L) return;
                            throw m;
                        } else "cancelDone" === h ? A.ta(a) : "objectTransfer" !== h && ("setimmediate" === c.data.target ? a.postMessage(c.data) : N("worker sent an unknown command " + h));
                        A.Ga = void 0
                    };
            ...
            function gb() {
                E || D || (ra || (ra = {}), ra["Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"] || (ra["Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"] = 1, N("Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread")))
            }
            ...
            function Z(a, b) {
                for (var c = arguments.length - 2, e = ib(), h = R(8 * c), g = h >> 3, m = 0; m < c; m++) {
                    var p = arguments[2 + m];
                    fa()[g + m] = p
                }
                c = jb(a, c, h, b);
            ...
            var kb = [],
                lb = [],
                mb = [0, "undefined" !== typeof document ? document : 0, "undefined" !== typeof window ? window : 0];

            function nb(a) {
                a = 2 < a ? Q(a) : a;
                return mb[a] || ("undefined" !== typeof document ? document.querySelector(a) : void 0)
            }
            ...
            function ob(a, b, c) {
                ...
                if (e.Ca || !e.bb) e.Ca && (e = e.Ca), a = !1, e.qa && e.qa.pa && (a = e.qa.pa.getParameter(2978), a = 0 === a[0] && 0 === a[1] && a[2] === e.width && a[3] === e.height), e.width = b, e.height = c, a && e.qa.pa.viewport(0, 0, b, c);
                else {
                    if (e.ra) {
                        e = v()[e.ra + 8 >> 2];
                        a = a ? Q(a) : "";
            ...
            var vb, wb = ["default", "low-power", "high-performance"],
                xb = {};
            ...
            function Gb(a, b, c, e) {
                ...
                for (var h = 0, g = 0; g < c; g++) {
                    for (var m = v()[b + 8 * g >> 2], p = v()[b + (8 * g + 4) >> 2], u = 0; u < p; u++) {
                        var r = t()[m + u],
                            w = bb[a];
                        0 === r || 10 === r ? ((1 === a ? qa : N)(wa(w, 0)), w.length = 0) : w.push(r)
                    }
                    h += p
                }
                v()[e >> 2] = h;
            ...
            function Ya(a) {
                if (F) throw "Internal Error! spawnThread() can only ever be called from main application thread!";
                var b = A.Ja();
            ...
            function Ib(a, b) {
                ...
                if (F && X() == a) return N("PThread " + a + " is attempting to join to itself!"), 16;
                if (!F && Jb() == a) return N("Main thread " + a + " is attempting to join to itself!"), 16;
                if (v()[a + 12 >> 2] !== a) return N("pthread_join attempted on thread " + a + ", which does not point to a valid thread, or does not exist anymore!"), 71;
                if (Atomics.load(y(), a + 64 >> 2)) return N("Attempted to join thread " + a + ", which was already detached!"), 28;
                for (gb();;) {
                    var c =
                        Atomics.load(y(), a + 0 >> 2);
                    if (1 == c) return c = Atomics.load(y(), a + 4 >> 2), b && (v()[b >> 2] = c), Atomics.store(y(), a + 64 >> 2, 1), F ? postMessage({
                        cmd: "cleanupThread",
                        thread: a
                    }) : Ra(a), 0;
                    if (F) {
                        var e = X();
                        if (e && !Atomics.load(y(), e + 56 >> 2) && 2 == Atomics.load(y(), e + 0 >> 2)) throw "Canceled!";
                    }
                    F || Xa();
                    hb(a + 0, c, F ? 100 : 1)
                }
            ...
            function Ob(a, b) {
                for (a = new Date(a.getTime()); 0 < b;) {
                    ...
                    if (b > e - a.getDate()) b -= e - a.getDate() + 1, a.setDate(1), 11 > c ? a.setMonth(c + 1) : (a.setMonth(0), a.setFullYear(a.getFullYear() + 1));
                    else {
            ...
            function Pb(a, b, c, e) {
                function h(f, q, x) {
                    for (f = "number" === typeof f ? f.toString() : f || ""; f.length < q;) f = x[0] + f;
                    return f
                }
                ...
                function m(f, q) {
                    ...
                    var O;
                    0 === (O = x(f.getFullYear() - q.getFullYear())) && 0 === (O = x(f.getMonth() - q.getMonth())) && (O = x(f.getDate() - q.getDate()));
                    return O
                }
                ...
                function u(f) {
                    ...
                    q = p(q);
                    return 0 >= m(x, f) ? 0 >= m(q, f) ? f.getFullYear() + 1 : f.getFullYear() : f.getFullYear() - 1
                }
                var r = v()[e + 40 >> 2];
                e = {
                    Xa: v()[e >> 2],
                ...
                r = {
                    ...
                    "%U": function(f) {
                        ...
                        return 0 >
                            m(x, f) ? g(Math.ceil((31 - x.getDate() + (Lb(Kb(f.getFullYear()) ? Mb : Nb, f.getMonth() - 1) - 31) + f.getDate()) / 7), 2) : 0 === m(x, q) ? "01" : "00"
                    },
                    "%V": function(f) {
                        ...
                        return 0 > m(O, x) ? "53" : 0 >= m(q, O) ? "01" : g(Math.ceil((x.getFullYear() < f.da + 1900 ? f.wa + 32 - x.getDate() : f.wa + 1 - x.getDate()) / 7), 2)
                    },
                    "%w": function(f) {
                        return f.va
                    },
                    "%W": function(f) {
                        var q = new Date(f.da, 0, 1),
                            x = 1 === q.getDay() ? q : Ob(q, 0 === q.getDay() ? 1 : 7 - q.getDay() + 1);
                        f =
                            new Date(f.da + 1900, f.la, f.oa);
                        return 0 > m(x, f) ? g(Math.ceil((31 - x.getDate() + (Lb(Kb(f.getFullYear()) ? Mb : Nb, f.getMonth() - 1) - 31) + f.getDate()) / 7), 2) : 0 === m(x, q) ? "01" : "00"
                    },
                    "%y": function(f) {
                ...
                for (w in r) 0 <= c.indexOf(w) && (c = c.replace(new RegExp(w, "g"), r[w](e)));
                w =
                    Qb(c);
            ...
            F || A.La();
            var Rb = [null, function(a, b) {
                if (F) return Z(1, 1, a, b)
            }, db, eb, fb, qb, Ab, Bb, Cb, Eb, Fb, Gb];
            ...
            var Vb = {
                c: function(a, b, c, e) {
                    M("Assertion failed: " + Q(a) + ", at: " + [b ? Q(b) : "unknown filename", c, e ? Q(e) : "unknown function"])
                },
                i: db,
                q: eb,
                r: fb,
                ...
                n: function(a, b, c) {
                    lb.length = 0;
                    var e;
                    for (c >>= 2; e = t()[b++];)(e = 105 > e) && c & 1 && c++, lb.push(e ? fa()[c++ >> 1] : v()[c]), ++c;
                ...
                a: k || z.wasmMemory,
                k: function(a, b, c, e) {
                    if ("undefined" === typeof SharedArrayBuffer) return N("Current environment does not support SharedArrayBuffer, pthreads are not available!"),
                        6;
                    if (!a) return N("pthread_create called with a null thread pointer!"), 28;
                    var h = [];
            ...
            (function() {
                function a(h, g) {
                    ...
                    if (!F) {
                        ...
                        A.fa.forEach(function(p) {
                            A.Ba(p, function() {
                                if (!--m && (S--, z.monitorRunDependencies && z.monitorRunDependencies(S), 0 == S && (null !== Ja && (clearInterval(Ja), Ja = null), T))) {
                                    var u = T;
                                    T = null;
                                    u()
                                }
                ...
                F || (assert(!F, "addRunDependency cannot be used in a pthread worker"),
                    S++, z.monitorRunDependencies && z.monitorRunDependencies(S));
                if (z.instantiateWasm) try {
                    return z.instantiateWasm(e, a)
                } catch (h) {
                    return N("Module.instantiateWasm callback failed with error: " + h), !1
                }(function() {
                    return P || "function" !== typeof WebAssembly.instantiateStreaming || Ka() || "function" !== typeof fetch ? c(b) : fetch(U, {
                        credentials: "same-origin"
                    }).then(function(h) {
            ...
            var Hb = z._emscripten_get_global_libc = function() {
                    return (Hb = z._emscripten_get_global_libc = z.asm.K).apply(null, arguments)
                },
            ...
            var X = z._pthread_self = function() {
                ...
                Ua = z.___pthread_tsd_run_dtors = function() {
                    return (Ua = z.___pthread_tsd_run_dtors = z.asm.O).apply(null, arguments)
                };
            z._emscripten_current_thread_process_queued_calls = function() {
                return (z._emscripten_current_thread_process_queued_calls = z.asm.P).apply(null, arguments)
            };
            var Ta = z._emscripten_register_main_browser_thread_id = function() {
                    return (Ta = z._emscripten_register_main_browser_thread_id = z.asm.Q).apply(null, arguments)
                },
                Jb = z._emscripten_main_browser_thread_id = function() {
                    return (Jb = z._emscripten_main_browser_thread_id = z.asm.R).apply(null, arguments)
                },
                Na = z.__emscripten_do_dispatch_to_thread = function() {
                    return (Na = z.__emscripten_do_dispatch_to_thread = z.asm.S).apply(null, arguments)
                },
                Tb = z._emscripten_sync_run_in_main_thread_4 = function() {
                    return (Tb = z._emscripten_sync_run_in_main_thread_4 =
                        z.asm.T).apply(null, arguments)
                },
                Xa = z._emscripten_main_thread_process_queued_calls = function() {
                    return (Xa = z._emscripten_main_thread_process_queued_calls = z.asm.U).apply(null, arguments)
                },
                jb = z._emscripten_run_in_main_runtime_thread_js = function() {
                    return (jb = z._emscripten_run_in_main_runtime_thread_js = z.asm.V).apply(null, arguments)
                },
                pb = z.__emscripten_call_on_thread = function() {
                    return (pb = z.__emscripten_call_on_thread = z.asm.W).apply(null, arguments)
                };
            ...
            var Sa = z.__emscripten_thread_init = function() {
                    return (Sa = z.__emscripten_thread_init = z.asm.Y).apply(null, arguments)
                },
                ...
                $a = z._emscripten_stack_set_limits = function() {
                    return ($a = z._emscripten_stack_set_limits = z.asm.aa).apply(null, arguments)
                },
                Ub = z._memalign = function() {
                    return (Ub =
                        z._memalign = z.asm.ba).apply(null, arguments)
                },
            ...
            function Yb(a) {
                    ...
                    if (!Wb && (Wb = !0, z.calledRun = !0, !ua)) {
                        ...
                        if (Zb) {
                            ...
                            try {
                                ...
                                u instanceof L || ("unwind" == u ? noExitRuntime = !0 : ((c = u) && "object" === typeof u && u.stack && (c = [u, u.stack]), N("exception thrown: " + c), ma(1, u)))
                            } finally {}
                        }
                        if (!F) {
                            if (z.postRun)
                                for ("function" == typeof z.postRun &&
                                    (z.postRun = [z.postRun]); z.postRun.length;) c = z.postRun.shift(), Ga.unshift(c);
                            Pa(Ga)
                        }
                    }
                }
                a = a || ka;
                if (!(0 < S))
                    if (F) ia(z), postMessage({
                        cmd: "loaded"
                    });
                    else {
                        if (!F) {
                            if (z.preRun)
                                for ("function" == typeof z.preRun && (z.preRun = [z.preRun]); z.preRun.length;) Ia();
                            Pa(Da)
                        }
                        0 < S || (z.setStatus ? (z.setStatus("Running..."), setTimeout(function() {
                            setTimeout(function() {
                                z.setStatus("")
                            }, 1);
                            b()
            ...
            if (z.preInit)
                for ("function" == typeof z.preInit && (z.preInit = [z.preInit]); 0 < z.preInit.length;) z.preInit.pop()();
            var Zb = !0;
            z.noInitialRun && (Zb = !1);
            noExitRuntime = !F;
            F && A.Na();
